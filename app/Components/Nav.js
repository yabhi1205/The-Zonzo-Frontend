    ...
    return (
        <>
            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <Link href={"https://yabhi1205.netlify.app/"} className="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src="https://yabhi1205.netlify.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FProfile.8be7fb0c.png&w=640&q=75" className=" h-16 my-0" alt="Abhinav Yadav" />
                        <span className="self-center my-auto text-2xl font-semibold whitespace-nowrap dark:text-white">Abhinav Yadav</span>
                    </Link>
                    {HomePage &&
                        <>
                            <div className="flex">
                                <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                                    <button type="button" className="flex text-sm bg-gray-800 ml-4 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
